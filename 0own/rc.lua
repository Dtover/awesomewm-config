...
-- Autorun programs and scripts at startup
awful.spawn.with_shell("~/.config/awesome/autorun.sh")
--do
	--awesome.connect_signal("startup", function(args)
		--awful.util.spawn('sh ~/.config/awesome/autorun.sh')
	--end)
--end
...
beautiful.init("/home/dtover/.config/awesome/themes/default/theme.lua")

-- This is used later as the default terminal and editor to run.
terminal = "termite"
floating_terminal = "termite -t scratchpad"
simpleterminal = "st"
editor = os.getenv("EDITOR") or "nvim"
editor_cmd = simpleterminal .. " -e " .. editor
...
myawesomemenu = {
   ...
   { "edit config", editor_cmd .. " " .. "/home/dtover/.config/awesome/rc.lua" },
...
clientkeys = gears.table.join(
    ...
    awful.key({ modkey, "Shift"   }, "q",      function (c) c:kill()                         end,
              {description = "kill the focused client", group = "client"}),
