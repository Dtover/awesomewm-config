...
function env:init(args)
	...
	self.stterminal = args.stterminal or "st"
	...
	self.idea = args.idea or "/opt/idea-IU-193.6911.18/bin/idea.sh"
	self.ssh = args.ssh or "st -e ssh root@47.99.77.16"
	self.bgpselector = args.bgpselector or "bgp"
	self.todo = args.todo or "st -n todo -e todo"
	self.asrl = args.asrl or "asrl"
	...
	self.set_slave = args.set_slave == false
