...
rules.floating_any = {
	...
	class = {
		...
		"xtightvncviewer","flameshot","Tk","Variety", "baidunetdisk","TelegramDesktop",
		"zoom","Fcitx-config-gtk3", "Wine"
	},
	name = { "Event Tester" },
...
function rules:init(args)
	...
	self.rules = {
		...
		{
			rule = { class = "Zathura" },
			properties = { screen = 1, tag = "Tag5", switchtotag = true }
		},
		{
			rule = { class = "Wpspdf" },
			properties = { screen = 1, tag = "Tag6" }
		},
		{
			rule = { class = "Wps" },
			properties = { screen = 1, tag = "Tag6" }
