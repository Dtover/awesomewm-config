...
function hotkeys:init(args)
	...
	self.raw.root = {
		...
		{
			{ env.mod, "Control" }, "o", function() redflat.float.top:show("mem") end,
			{ description = "Show cpu usage", group = "Widgets" }
		},
		{
			{ env.mod, "Control" }, "i", function() redflat.float.top:show("cpu") end,
